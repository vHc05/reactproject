...
function Home() {
  return (
    <>
      <Header />
      <h1 className="home-h1">La Ruta del Agua</h1>
      <div className="home-container">
        <div className="home-row">
          <div className="home-column-66">
            <img className="home-images" src="../../public/fotos_home/corredor_paisajistico.jpg"></img>
          </div>
          <div className="home-column-33">
            <p className="home-text">Esta ruta peatonal y ciclista conecta a lo largo de 13 kilómetros las medianías teldenses
      ...
      <div className="home-container">
        <div className="home-row">
          <div className="home-column-33">
            <p className="home-text">Datan del siglo XX. Durante todo un siglo han sido
          ...
          <div className="home-column-66">
            <img className="home-images" src="../../public/fotos_home/Acequia_lavadero_de_la_Heredad.jpg"></img>
          </div>
        </div>
      </div>
      ...
      <div className="home-container">
        <div className="home-row">
          <div className="home-column-66">
            ...
            <p className="home-text">Construido según planos diseñados por el teldense Juan de León
          ...
          <div className="home-column-33">
            <img className="home-images" src="../../public/fotos_home/Acueducto_de_Los_Rios.jpg"></img>
          </div>
        </div>
      </div>
      ...
      <div className="home-container">
        <div className="home-row">
          <div className="home-column-66">
            <img className="home-images" src="../../public/fotos_home/dique_para_desvio_aguas.jpg"></img>
          </div>
          <div className="home-column-33">
            <p className="home-text">Se trata de una construcción que se realizaba
      ...
      <div className="home-container">
        <div className="home-row">
          <div className="home-column-66">
            <p className="home-text">Son pozos de ventilación asociados a minas o galerías filtrantes que
              captan el agua subterránea de los barrancos.Construida en el S. XX con cantos de piedra
              seca.</p>
          </div>
          <div className="home-column-33">
            <img className="home-images" src="../../public/fotos_home/Campana_de_agua.jpg"></img>
          </div>
        </div>
      </div>
      ...
      <div className="home-container">
        <div className="home-row">
          <div className="home-column-66">
            <img className="home-images" src="../../public/fotos_home/Mina_molino_Longueras.jpg"></img>
          </div>
          <div className="home-column-33">
            <p className="home-text">Es una de las obras de ingeniería hidráulica mas
      ...
      <div className="home-container">
        <div className="home-row">
          <div className="home-column-66">
            <p className="home-text">Levantado a mediados del siglo XIX, es una de las piezas
          ...
          <div className="home-column-33">
            <img className="home-images" src="../../public/fotos_home/Puente_siete_ojos.jpg"></img>
          </div>
        </div>
      </div>
      ...
      <div className="home-container">
        <div className="home-row">
          <div className="home-column-66">
            <img className="home-images" src="../../public/fotos_home/Puente_Tara.jpg"></img>
          </div>
          <div className="home-column-33">
            <p className="home-text">Se concibió a principios del siglo XX como vía de comunicación para
